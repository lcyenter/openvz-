...
wget --no-check-certificate https://raw.githubusercontent.com/lcyenter/openvz-/master/lkl/liblkl-hijack.so
...
iptables -t nat -A PREROUTING -i venet0 -p tcp --dport 22:9999 -j DNAT --to-destination 10.0.0.2
